    ...
    return (
      ...
      >
        <textarea
          ...
          className={cn(
            `flex h-50 w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-textarea rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
